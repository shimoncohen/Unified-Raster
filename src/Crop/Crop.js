...
export default function Crop(props) {
    ...
    const createNewExtent = () => {
        ...
        const bottomLeft = [extent[0] + crop.x / imgWidth * rasterWidthGeo,
        extent[1] + (imgHeight - (crop.y + crop.height)) / imgHeight * rasterHeightGeo];
        const topRight = [extent[2] - ((imgWidth - (crop.x + crop.width)) / imgWidth * rasterWidthGeo),
